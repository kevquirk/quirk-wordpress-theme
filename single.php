...
?>
	...
	<div id="primary">
		...
		<?php
	  	...
	  	echo '<div class="old-notice"><i class="fa fa-exclamation-triangle la-lg" aria-hidden="true"></i> THIS IS AN OLD POST <i class="fa fa-exclamation-triangle la-lg" aria-hidden="true"></i><br>
			This post was last updated over a year ago, therefore the contents of this post may be out of date. Please see my <a href="/disclaimer">disclaimer</a> for more information.</div>';
			}
		?>
		<?php
		while ( have_posts() ) :
